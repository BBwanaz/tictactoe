// Lightly modified to work with DE1-SoC.  Note the Verilog in this file does
// not conform to the style guidelines for EECE 259 as state is not in
...
begin
	if (reset)
	begin
		pixel_counter	<= H_TOTAL - 20; // 3; // {PW{1'b0}};
